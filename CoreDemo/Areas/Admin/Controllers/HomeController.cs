...
namespace CoreDemo.Areas.Admin.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> ChangeProfileInformations(ReadUserViewModel viewModel)
        {
            ...
            return Redirect($"/{nameof(Admin)}/{nameof(HomeController).Replace("Controller", "")}/{nameof(HomeController.Homepage)}");
        }
        ...
        public async Task<IActionResult> ChangePassword(UserPasswordViewModel viewModel)
        {
            ...
            {
                TempData["Message"] = ToastrNotification.Show(_localizer["NewAndOldPasswordAreSame"], position: Position.BottomRight,
